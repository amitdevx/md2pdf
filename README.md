...
### Available (v0.5.2)
- **Mermaid Syntax Tolerance (New in v0.5.2):** Strict Mermaid compilation with relaxed Obsidian syntax tolerance. Automatically unescapes quotes in graph nodes and repairs empty mindmap shapes to prevent layout crashes without sacrificing native engine correctness.
