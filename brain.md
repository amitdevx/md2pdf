...
│  unified()                                               │
│    .use(remarkParse)                                     │
│    .use(remarkWikiLinks)      ← Obsidian [[links]]       │
│    .use(remarkHighlight)      ← Obsidian ==highlight==   │
│    .use(remarkTags)           ← Obsidian #tags           │
│    .use(remarkEmbeds)         ← Obsidian ![[embeds]]     │
│    .use(remarkMath)           ← KaTeX math parsing       │
│    .use(remarkGfm)            ← GFM tables, footnotes    │
│    .use(remarkRehype, { allowDangerousHtml: true })      │
│    .use(rehypeKatex)          ← KaTeX math HTML          │
│    .use(rehypeSlug)           ← heading id attributes    │
│    .use(rehypeCallouts)       ← Obsidian > [!info]       │
...
package.json
package-lock.json
phase/GOLDEN-DOCUMENTS.md
phase/README.md
phase/v0.0.1-foundation.md
phase/v0.0.2-packaging.md
phase/v0.1.0-core-rendering.md
phase/v0.1.1-toc-footnotes.md
phase/v0.1.3-headers-footers.md
phase/v0.2.0-error-handling-plan.md
phase/v0.2.0-mermaid.md
phase/v0.2.1-mermaid-improvements.md
phase/v0.3.0-math.md
phase/v0.4.0-obsidian-core.md
phase/v0.4.1-obsidian-embeds.md
phase/v0.5.0-config.md
phase/v0.6.0-themes.md
phase/v0.7.0-plugins.md
phase/v0.8.0-performance.md
phase/v0.9.0-stabilization.md
phase/v0.9.x-bugfixes.md
...
src/assets/css.ts
src/assets/katex.ts
src/assets/obsidian.ts
src/cli/doctor.ts
src/cli/index.ts
src/cli/init.ts
src/core/index.ts
src/errors/detect.ts
src/errors/index.ts
src/errors/recommendations.ts
src/index.ts
src/parser/index.ts
src/pdf/browser.ts
src/pdf/index.ts
src/pdf/metadata.ts
src/plugins/mermaid/detector.ts
src/plugins/mermaid/index.ts
src/plugins/mermaid/inliner.ts
src/plugins/mermaid/renderer.ts
src/plugins/mermaid/theme-map.ts
src/plugins/obsidian/attachments.ts
src/plugins/obsidian/callouts.ts
src/plugins/obsidian/embeds.ts
src/plugins/obsidian/highlight.ts
src/plugins/obsidian/tags.ts
src/plugins/obsidian/wiki-links.ts
src/plugins/page-breaks.ts
src/plugins/toc.ts
src/README.md
src/renderer/index.ts
src/renderer/pipeline.ts
src/types/index.ts
STRUCTURE.md
templates/README.md
test-parser.js
tests/benchmarks/mermaid-50-diagrams.md
...
tests/fixtures/headers-footers.md
tests/fixtures/highlight.md
tests/fixtures/images.md
tests/fixtures/long-document.md
tests/fixtures/math-check.md
tests/fixtures/mermaid-charts.md
tests/fixtures/mermaid-class.md
tests/fixtures/mermaid-er.md
tests/fixtures/mermaid-errors.md
tests/fixtures/mermaid-flowchart.md
tests/fixtures/mermaid-mixed.md
tests/fixtures/mermaid-narrative.md
tests/fixtures/mermaid-sequence.md
tests/fixtures/mermaid-state.md
tests/fixtures/metadata.md
tests/fixtures/nested-lists.md
tests/fixtures/obsidian-callouts.md
tests/fixtures/obsidian-embeds-circular.md
tests/fixtures/obsidian-embeds-images.md
tests/fixtures/obsidian-embeds-notes.md
tests/fixtures/obsidian-frontmatter.md
tests/fixtures/obsidian-tags.md
tests/fixtures/obsidian-wiki-links.md
tests/fixtures/page-breaks.md
tests/fixtures/README.md
tests/fixtures/tables.md
tests/fixtures/toc.md
tests/fixtures/vault/assets/sample.svg
tests/fixtures/vault/circular-1.md
tests/fixtures/vault/circular-2.md
tests/fixtures/vault/embedded-note.md
tests/parser/highlight.test.ts
tests/parser/index.test.ts
tests/pdf/index.test.ts
tests/README.md
tests/renderer/index.test.ts
...
### `src/plugins/mermaid/index.ts`
```ts
export { rehypeMermaidDetector } from './detector.js';
export type { MermaidBlock, MermaidDetectorOptions } from './detector.js';
export { renderMermaidBlocks } from './renderer.js';
export type { RenderedMermaid } from './renderer.js';
export { inlineMermaidSvgs } from './inliner.js';
```
...
13. injectMetadata(out.pdf, metadata)
    ...
    - Set title, author, subject, keywords, creator: "md2pdf 0.4.1", producer: "Playwright"
